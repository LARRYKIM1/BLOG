...
public class Item09 {
    ...
    public static void main(String[] args) throws IOException {
        String path = "src/com/larrykim/item09/data.txt";
...
close에서 발생한 예외는 숨겨지고 readLine에서 발생한 예외가 기록된다. 이렇게 숨겨진 예외들도 그냥 버려지지는 않고, 스택 추적 내역에 "숨겨졌다"는 \(suppressed\) 꼬리표를 달고 출력된다. 또한, 자바 7에서 Throwable에 추가 된 getSuppressed\(\)를 이용하면 프로그램 코드에서 가져올 수도 있다. [try-with-resource suppressed 예제](https://www.geeksforgeeks.org/throwable-getsuppressed-method-in-java-with-examples/)
...
* 각 인스턴스가 본질적으로 고유하다. 예를들어, [Thread](https://stackoverflow.com/questions/26382093/questions-from-effective-java-bookjoshua-bloch)
...
public class ColorPoint {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(point.equals(colorPoint1)); //true
        System.out.println(point.equals(colorPoint2)); //true
        System.out.println(colorPoint2.equals(colorPoint1)); //true
    }
}
```
