...
![&#xCD9C;&#xCC98;: &#xAE40;&#xC601;&#xD55C; &#xC800; &quot;&#xC790;&#xBC14; ORM &#xD45C;&#xC900; JPA &#xD504;&#xB85C;&#xADF8;&#xB798;&#xBC0D;&quot;](../../.gitbook/assets/image%20%2842%29.png)

#### 트랜잭션 롤백을 표시하지 않는 예외

* 심각한 예외가 아니다. 개발자가 판단해서 트랜잭션 커밋, 롤백한다

![&#xCD9C;&#xCC98;: &#xAE40;&#xC601;&#xD55C; &#xC800; &quot;&#xC790;&#xBC14; ORM &#xD45C;&#xC900; JPA &#xD504;&#xB85C;&#xADF8;&#xB798;&#xBC0D;&quot;](../../.gitbook/assets/image%20%2845%29.png)

### 1.2 스프링 프레임워크의 JPA 예외 변환

* 서비스 계층에서 데이터 접근 계층의 구현 기술에 직접 의존하는 것은 좋은 설계라 할 수 없다. 예외도 마찬가지인데，예를 들어 서비스 계층에서 JPA의 예외를 직접 사용하면 JPA에 의존하게 된다. 추상화된 예외들이다.
...
public class NoResultExceptionTestRepository {
    ...
    //리턴값이 없다고 가정 
    //javax.persistence.NoResultException 발
